...
namespace ComplianceSheriff.Permission
{
    public class PermissionService : IPermissionService
    {
        ...
        public async Task DeleteUserGroupPermissionByUserGroupId(int userGroupId)
        {
            await _userPermissionMutator.DeleteUserGroupPermissionsByUserGroupId(userGroupId);
        }
