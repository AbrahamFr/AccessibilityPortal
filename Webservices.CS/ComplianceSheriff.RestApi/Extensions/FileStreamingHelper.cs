        ...
        public static async Task<FormValueProvider> StreamFile(this HttpRequest request, Stream targetStream)
        {
            ...
            while (section != null)
            {
                ...
                {                    
                    ...
                    {
                        var formFileName = section.GetContentDispositionHeader().FileName.ToString().ToLower().Trim();
                        if (formFileName.Contains("\\"))
                        {
                            uploadFileName = formFileName.Substring(formFileName.LastIndexOf("\\")+1).Replace("\\","");
                        } else
                        {
